...
class LahanExport extends ExcelExport implements WithDrawings, WithCustomStartCell
{
    public function setUp(): void
    {
        $this->withFilename('Data_Lahan_Jagung_' . now()->format('Y-m-d'));
    }
    ...
    public function registerEvents(): array
    {
        ...
        return array_merge($parentEvents, [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Garis tipis di bawah garis tebal (baris 7)
